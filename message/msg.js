/**
  ...
  */
  ...
  const nyoutube = ('© Fauzi\nYoutube/Sc :\nhttps://youtube.com/channel/UCsPV27lGj8oEEPlRwdd05Yg')  //ganti link yt ente
  ...
  //=======================================================//
   ...
   //=======================================================//
    ...
    switch(order){
      ...
      case prefix+'public':{
         if(!isOwner) return msg.reply('Khusus Owner Deck!!!!')
     ...
     client.DeleteMessage(ah, botNumber)
      ...
      case prefix+'m': case prefix+'menu':{//Rfz XM
           client.sendMessage(from, { react: { text: "⏱️", key: msg.key }})
             ...
             let sourceUrl =  'https://instagram.com/fauzibeban__'
             let mediaUrl = 'https://instagram.com/fauzibeban__'
...
client.sendMessage(from, { image: anu, caption: `Beliau ini....` }, { quoted: msg}).catch((err) => m.reply('Link Sedang Eror! Coba Lagi Nanti')) 
}
break
//
case prefix+'couple':{
                ...
                client.sendMessage(from, { image: { url: random.male }, caption: `Couple Male` }, { quoted: msg })
                client.sendMessage(from, { image: { url: random.female }, caption: `Couple Female` }, { quoted: msg })
            }
	    break
//
case prefix+'apakah':{
            	if(!q) return msg.reply("${prefix + command} aku menang.")
            	let apa = ['Iya','Tidak','Bisa Jadi','Coba Ulangi','Mungkin Saja','Coba Tanyakan Ayam']
                let kah = apa[Math.floor(Math.random() * apa.length)]
                let jawab = `*Apakah ${text}*\nJawab : ${kah}`
            await client.sendButtonText(m.chat, jawab, msg)
            }
            break
//
case prefix+'motivasi':{
                ...
                let buttons = [
                    {buttonId: `motivasi`, buttonText: {displayText: 'Like♥️'}, type: 1}
                ]
                let buttonMessage = {
      ...
      let aud = {
          ...
          contextInfo:{
           externalAdReply:{
             ...
             thumbnail: thumb,
             sourceUrl: "https://instagram.com/mdappaa_1",
             mediaUrl: "https://instagram.com/mdappaa_1",
